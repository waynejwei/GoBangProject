...
APIKey = "N2qRH6A65cCuWCyBjuu58QK6"   # 从百度云API获取：https://ai.baidu.com/ai-doc/REFERENCE/Ck3dwjgn3
SecretKey = "iNmSEjT3t5dz6Tc58DpvTmIr0MEZsoHg"
...
def speech2text(speech_data, token, dev_pid=1537):
    ...
    RATE = '16000'
    CHANNEL = 1
    CUID = '70-C9-4E-43-50-A1'   # 用户唯一标识，用来区分用户，计算UV值。建议填写能区分用户的机器 MAC 地址或 IMEI 码，长度为60字符以内。
